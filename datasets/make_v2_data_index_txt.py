...
image_file_path = r"./virtual_smoke_v2/images"
save_path = r"./virtual_smoke_v2/images_index/"

train_val_percent = 0.96
train_percent = 0.9
...
test_stream = open(os.path.join(save_path, "test.txt"), "w")
