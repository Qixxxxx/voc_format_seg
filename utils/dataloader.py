...
class CustomDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        #   从文件中读取图像
        # -------------------------------#
        image = Image.open(os.path.join(os.path.join(self.dataset_path, "VOC2007/JPEGImages"), name + ".jpg"))
        label = Image.open(os.path.join(os.path.join(self.dataset_path, "VOC2007/SegmentationClass"), name + ".png"))
        # -------------------------------#
        #   数据增强
        # -------------------------------#
